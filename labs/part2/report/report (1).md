...
1. Тест по теме роль системного адмистратора Linux. (см. рис. [labs/lab01/Images/02.jpg]).  

   !Что относится к философии свободного ПО?{ labs/lab01/Images/02.jpg }


2.  Тест по теме роль системного адмистратора Linux.см .рис. [labs/lab01/Images/03.jpg]).
   !Инструмент для мониторинга серверов{ #fig:002 }

3. Тест по теме роль системного адмистратора Linux. (см. рис. [labs/lab01/Images/03.jpg]).  

   !Ключевые обязаности системного администратора{ labs/lab01/Images/03.jpg  }
