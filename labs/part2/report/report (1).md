...
1. Тест по теме работа с текстовыми файлами Linux. (см. рис. [
Выполнить курс Системный администратор Linux с нуля.
...
1. Тест по теме работа с текстовыми файлами Linux. (см. рис. [labs/lab01/Images/02.jpg]).  
...
В ходе выполнения 2 части курса Системный администратор Linux с нулябыли изучены основные принципы работы Linux
